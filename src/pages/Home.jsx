      ...
      <section className="py-24 px-6 border-t border-white/8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            {[
              { name: "Starter", price: "$79", desc: "The sole performer. Film yourself, beautifully.", cta: "Start trial" },
              { name: "Elite", price: "$199", desc: "Mia + Oliver are your AI presenters. You don't film a thing.", cta: "Start trial", popular: true },
              { name: "Concierge", price: "$399", desc: "Virtual Twin. Total automation. Bespoke avatar.", cta: "Begin VIP intake" },
            ].map((plan) => (
              <div key={plan.name} className={`p-6 rounded-2xl border text-left transition-all ${plan.popular ? "border-[#C99A2E]" : "border-white/10"}`} style={{ background: plan.popular ? "rgba(201,154,46,0.06)" : "rgba(255,255,255,0.03)" }}>
